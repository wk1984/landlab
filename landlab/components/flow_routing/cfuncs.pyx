...
def adjust_flow_receivers(np.ndarray[np.int_t, ndim=1] src_nodes,
                          np.ndarray[np.int_t, ndim=1] dst_nodes,
                          np.ndarray[DTYPE_FLOAT_t, ndim=1] z,
                          np.ndarray[DTYPE_FLOAT_t, ndim=1] link_slope,
                          np.ndarray[np.int_t, ndim=1] active_links,
                          np.ndarray[np.int_t, ndim=1] receiver,
                          np.ndarray[np.int_t, ndim=1] receiver_link,
